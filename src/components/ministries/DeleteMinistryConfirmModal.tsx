...
interface DeleteMinistryConfirmModalProps {
  ministry: ChurchMinistry | null;
  isOpen: boolean;
  onClose: () => void;
  onConfirm: (ministry: ChurchMinistry) => void;
}

export const DeleteMinistryConfirmModal: React.FC<DeleteMinistryConfirmModalProps> = ({
  ministry,
  isOpen,
  onClose,
  onConfirm,
  ...
  return (
    <div
      id="modal-delete-ministry-backdrop"
      className="fixed inset-0 z-50 bg-stone-900/60 backdrop-blur-xs flex items-center justify-center p-4"
      onClick={onClose}
    >
      <div
        id="modal-delete-ministry-content"
      ...
      >
        <div className="flex items-start gap-3.5">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-stone-600 mt-1">
              Tem certeza que deseja remover este ministério da listagem?
            </p>
        ...
        <div className="flex items-center justify-end gap-2.5 mt-6 pt-3 border-t border-stone-100">
          ...
          <button
            id="btn-confirm-delete-ministry"
            type="button"
            onClick={() => {
              onConfirm(ministry);
              onClose();
