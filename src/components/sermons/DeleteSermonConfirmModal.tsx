...
interface DeleteSermonConfirmModalProps {
  sermon: ChurchSermon | null;
  isOpen: boolean;
  onClose: () => void;
  onConfirm: (sermon: ChurchSermon) => void;
}

export const DeleteSermonConfirmModal: React.FC<DeleteSermonConfirmModalProps> = ({
  sermon,
  isOpen,
  onClose,
  onConfirm,
  ...
  return (
    <div
      id="modal-delete-sermon-backdrop"
      className="fixed inset-0 z-50 bg-stone-900/60 backdrop-blur-xs flex items-center justify-center p-4"
      onClick={onClose}
    >
      <div
        id="modal-delete-sermon-content"
        ...
        <div className="flex items-start gap-3.5">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-stone-600 mt-1">
              Tem certeza que deseja remover este sermão da listagem?
            </p>
            ...
            <div className="bg-stone-50 border border-stone-200 rounded-xl p-3 my-3 text-xs">
              ...
              <span className="text-[11px] text-stone-600 block mt-0.5">
                {sermon.preacher} {sermon.scriptureReference ? `• ${sermon.scriptureReference}` : ''}
              </span>
